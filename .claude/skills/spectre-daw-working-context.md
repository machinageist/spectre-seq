---
name: spectre-daw-working-context
description: "Load first for any Spectre task. Establishes repository shape, implementation order, invariants, quality gates, and how agents should use the local skills and agents."
---

<!--
Author: Jeff
Date: 2026-05-27
Description: Project working context for Spectre agents
Notes: Load first for every Spectre implementation or review task
-->

# Spectre Working Context

## Purpose

This repository contains one specification-first Spectre implementation workspace.
...
- Graph, audio, DSP, plugin, and transport work: load `spectre-realtime-rust`.
- Any review: load `spectre-validation-gates`.
