...
Author: Jeff
Date: 2026-07-11
Description: Vetted public DSP engineering literature register for Spectre native DSP work
...
- **Scope:** authoritative public literature Spectre native DSP contracts and implementations may cite
...
This register exists so that every Spectre DSP algorithm can cite its mathematical basis per rebuild-mandate §12.4 ("original algorithms and clearly documented references where standard DSP literature is used"). These are engineering references: standard public knowledge, not competitor products. Rules:

1. Spectre implements algorithms from theory; it does not copy source code from books or forums unless the license explicitly permits and the provenance is recorded.
...
| ID | Work | Author | Access | License / terms | Spectre relevance |
|---|---|---|---|---|---|
...
## How these map to likely Spectre DSP domains

| Spectre domain | Primary references |
|---|---|
