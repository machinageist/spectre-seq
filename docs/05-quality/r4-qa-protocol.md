...
| 4 | **Transport honesty** | The position readout does not show a frozen or fabricated position when the engine is not running. Today it reads `—`; confirm it still does rather than inventing a number |
