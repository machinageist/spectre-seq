...
- `spectre-dsp`: planar-buffer processing contract, a callback-safe runtime parameter seam, bounded note events, deterministic tone source, Pulse instrument, Gain, Saturator, and the `SumBus` summing device;
