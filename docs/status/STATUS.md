...
- **Known gaps:** no live driver has been opened and no hardware lifecycle drill has run; MIDI timestamp plumbing and off-thread health telemetry are not implemented; the app does not use the audio crate
