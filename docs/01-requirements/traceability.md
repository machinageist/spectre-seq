...
Full-gate result (2026-08-06, repository root, rustc/cargo 1.97.1): formatting clean; strict Clippy clean; 155/155 tests pass; `./geist --smoke-test` identifies Pulse selection and the offline self-test passes. The interaction evidence includes 27/27 app-model tests and 1/1 process smoke test; the offline harness remains 21/21. R2 silence/impulse/allocation/hash gates remain green on the unchanged compiled-plan path.
